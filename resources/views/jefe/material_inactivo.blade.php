...
<div class="form-row">
  ...
  <div class="form-group col-sm-4">
   ...
   <form action="{{route ('buscar_material_inac_jefe')}}" method="POST" id="busca" hidden>
     {{ csrf_field() }}
     <div class="form-row">
  ...
  <form action="{{route ('buscar_materialtipo_inac_jefe')}}" method="POST" id="tipo" hidden>
   {{ csrf_field() }}
   <div class="form-row">
...
<form action="{{route ('buscar_materialarea_inac_jefe')}}" method="POST" id="area" hidden>
 {{ csrf_field() }}
 <div class="form-row">
 ...
 @if(isset($inactivo))
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{ route('activar_material_jefe',$mats->id_material)}}">Activar</a></td>
      <td><a style="color: #306D00;" href="{{ route('detalles_material_jefe',$mats->id_material )}}">Detalles<i class="fa fa-eye"></i></a></td>
