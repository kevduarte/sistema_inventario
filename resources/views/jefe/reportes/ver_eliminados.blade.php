          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
             <li class="breadcrumb-item"><a href="#">Reportes</a></li>
              ...
              <li class="breadcrumb-item active"><a href="{{ route('reporte_eliminados_jefe')}}">baja definitiva</a></li>
  ...
  @foreach($veruni as $uni)
      ...
      <tr>
        ...
        <td>{!! $uni->estado !!}</td>
          ...
          <td WIDTH="50"><a href="/baja_definitiva_reporte_jefe/{{$uni->codigo_unidad}}/{{$uni->id_material}}" target="_blank"><button type="button" class="btn btn-info btn-sm">Generar</button></a></td>
