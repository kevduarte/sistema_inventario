...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-size: 2.0em; font-family:Constantia; font-weight: 900;">Baja definitiva</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
             <li class="breadcrumb-item"><a href="#">Reportes</a></li>
              <li class="breadcrumb-item active">baja definitiva</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<div class="form-row">
  ...
  <div class="form-group col-sm-4">
   ...
   <form action="{{route ('buscar_material_jefe')}}" method="POST" id="busca" hidden>
     {{ csrf_field() }}
     <div class="form-row">
  ...
  <form action="{{route ('buscar_materialtipo_jefe')}}" method="POST" id="tipo" hidden>
   {{ csrf_field() }}
   <div class="form-row">
...
<form action="{{route ('buscar_materialarea_jefe')}}" method="POST" id="area" hidden>
 {{ csrf_field() }}
 <div class="form-row">
...
<!--ESTA TABLA TABLA APARECE CUANDO SE HACE LA BUSQUEDA -->
 ...
 @if(isset($activo))
     ...
     <h2 style= "font-family: 'initial';">Relación de materiales con unidades eliminadas</h2>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a style="color:blue;" href="{{ route('ver_eliminados_jefe',$mats->id_material )}}">Ver detalles<i class="fa fa-eye"></i></a></td>
 ...
 @if(isset($details))
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{ $mats->tipo}}</td>
      <td>{{ $mats->area}}</td>
      <td><a style="color:blue;" href="{{ route('detalles_material_jefe',$mats->id_material )}}">Ver detalles<i class="fa fa-eye"></i></a></td>
      <td><a style="color:red;" href="{{ route('desactivar_material_jefe',$mats->id_material)}}">Desactivar material<i class="fa fa-eraser"></i></a></td>
    </tr>
