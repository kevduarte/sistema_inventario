...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-size: 2.0em; font-family:Constantia; font-weight: 900;">Reporte baja temporal</h1> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Reportes</a></li>

              <li class="breadcrumb-item active"><a href="{{ route('reporte_temporal_jefe')}}">baja temporal</a></li>
...
<div class="row">
              <div class="col-12" >
                ...
                <div class="col">
                 ...
                 <div class="col">
                  <div class="info-box bg-light">
                    <div class="info-box-content">
                      <span class="info-box-text text-center text-muted">Baja temporal:</span>
  ...
  <h2 style= "font-family: 'initial';">Relación de unidades con baja temporal del material: {{$ver}} </h2>
  ...
  @foreach($veruni as $uni)
      ...
      <tr>
        ...
        <td>{!! $uni->estado !!}</td>
             ...
             <td WIDTH="50"><a href="/baja_reporte_jefe/{{$uni->codigo_unidad}}/{{$uni->id_material}}" target="_blank"><button type="button" class="btn btn-info btn-sm">Generar</button></a></td>
