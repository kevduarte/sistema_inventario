 ...
 <!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1  style="font-size: 2.0em; font-family: 'Constantia'; font-weight: 900;">Detalles del adeudo </h1>
          </div>
          <div class="col-sm-6">
       ...
       <h2>Vales de reguardo</h2>
                                 ...
                                 <tbody>
                                    ...
                                    <tr >
                                        ...
                                        <td><a href="/detalles_valeadeudo_jefe/{{$det->id_vale}}"><button type="button" class="btn btn-primary btn-sm">ALUMNOS <i class="fa fa-users" aria-hidden="true"></i></button></a></td>
                                           ...
                                           <td><a href=""><button type="button" class="btn btn-success btn-sm" onclick="preguntar(event)">Liberar <i class="fa fa-check" aria-hidden="true"></i></button></a></td>
                                        </tr>
                                          @endforeach
                                    </tbody>
                                </table>
