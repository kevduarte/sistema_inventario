  ...
  @foreach($veruni as $uni)
      ...
      <tr>
        ...
        <td>{!! $uni->estado !!}</td>
         ...
         href="{{ route('desactivar_unidad_jefe',$uni->codigo_unidad)}}" ><?php if($uni->estado=='disponible'){echo "Baja temporal";}?></a></td>

         <td WIDTH="50" style="text-align: center;  " colspan="1" ><a style="color: #306D00;"
         href="{{ route('activar_unidad_jefe',$uni->codigo_unidad)}}" ><?php if($uni->estado=='no disponible'){echo "Activar";}?> </a></td>

          <td WIDTH="50" style="text-align: center;  " colspan="1" ><a style="color: red;"
         href="{{ route('baja_unidad_def_jefe',$uni->codigo_unidad)}}" ><?php if($uni->estado=='disponible'){echo "Baja definitiva";}?> </a></td>
