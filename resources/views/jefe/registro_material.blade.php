...
<form method="POST" action="{{ route('registrar_materiales_jefe') }}">
  @csrf
...
<div class="form-row">
 ...
 <div class="form-group col-md-4" hidden>
  ...
  <input type="tel" name="cantidad" id="cantidad" value="1" class="form-control" onkeypress="return numeros (event)">
