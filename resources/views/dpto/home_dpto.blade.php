        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route ('departamento')}}">Jefe dpto</a></li>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align: center;"><a style="color: #306D00; font-family: Arial, Helvetica, sans-serif ;"
         href= "{{ route('actualiza_material', $material->id_material) }}"><?php if($material->tipo=='INSUMOS'){echo "Actualizar";}?></a></td>

       <td style="text-align: center;">
      <a style="color: #306D00;" href="{{ route('ver_unidades',$material->id_material )}}"><?php if($material->tipo=='INSUMOS'){echo "Ver cantidad";}else{echo "Ver unidades";}?></a></td>
...
<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align: center;"><a style="color: #306D00; font-family: Arial, Helvetica, sans-serif ;"
       href= "{{ route('actualiza_material', $mats->id_material) }}"><?php if($mats->tipo=='INSUMOS'){echo "Actualizar";}?></a></td>
       <td style="text-align: center;">
       <a style="color: #306D00;" href="{{ route('ver_unidades',$mats->id_material )}}"><?php if($mats->tipo=='INSUMOS'){echo "Ver cantidad";}else{echo "Ver unidades";}?></a></td>
