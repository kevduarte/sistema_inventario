    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><a href="{{ route('ver_unidades',$unidad->id_material )}}">ver unidades</a></li>
...
<h2  style= "font-family: 'initial';">Eliminar del inventario la unidadd: {{$unidad->codigo_unidad}} </h2>
<div class="container">
  <div class="alert alert-warning alert-dismissible">
      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
      <h5><i class="icon fas fa-exclamation-triangle"></i> Alerta!</h5>
      Si elimina la unidad de manera definitiva, desaparecerá del registro del inventario.
    </div>
</div>
    ...
    <form method="POST" action="{{ route('baja_unidad_definitiva') }}" onsubmit="return confirmation()">
...
<div class="container">
   <p style="color: #002A6C"align="center"><span style="color: red;"><strong>nota:</strong></span> registre el motivo por el cual dará de baja la unidad de manera definitiva.</p>
</div>
...
@endsection
 ...
 <script type="text/javascript">
     ...
     {
        if(confirm("Una vez enviado el formulario la unidad no podra volver al inventario ¿desea continuar?"))
  {
     return true;
  }
  else
