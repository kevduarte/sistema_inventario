...
@if (Session::has('message'))
  ...
  <tbody>
   ...
   <tr>
    ...
    <td><a style="color: red;" href="{{ route('desactivar_encargado_dpto',$encargados->id_user)}}">Desactivar</a></td>
    <td><a  style="color: green;" href="{{ route('restablecer_contra_dpto',$encargados->id_user)}}" >Restablecer contraseña</a></td>
  </tr>
  @endforeach
</tbody>
