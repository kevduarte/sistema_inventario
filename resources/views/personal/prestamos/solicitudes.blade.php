...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1  style="font-size: 2.0em; font-family: 'Constantia'; font-weight: 900;">Solicitudes de material</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Prestamos</a></li>
              <li class="breadcrumb-item active">solicictudes de material</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <tbody>
    ...
    <tr>
     ...
     <td>{{ $sol->estado}}</td>
               <td>{{ $sol->tipo_prestamo}}</td>


     <td ><a href="/detalles_solicitud/{{$sol->id_solicitud}}"><button type="button" class="btn btn-primary btn-sm">Ver <i class="fa fa-eye" aria-hidden="true"></i></button></a></td>
