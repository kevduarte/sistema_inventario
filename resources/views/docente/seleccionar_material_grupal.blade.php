...
<!-- Content Header (Page header) -->
  ...
  <div class="container" id="font1">
    ...
    <form method="POST" action="{{ route('agregar_material_grupal') }}">
      @csrf
 ...
 <div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{ route ('quitar_carro_grupal',$mats->id_material)}}"><button type="button" class="btn btn-danger btn-sm">&nbsp;Quitar<i class="fa fa-trash"></i></button></a></td>
...
@endif
 ...
 <br>
  ...
  <form method="POST" action="{{ route('solicitud_enviada_grupal') }}">
      @csrf
...
if ($tipo=='2') {
  echo ' <p style="color: #002A6C;" align="left"><span style="color: red;"><strong>nota:</strong></span> Préstamo Grupal</p>';
}
if ($tipo=='3') {
