...
<form method="POST" action="{{ route('registrar_docente') }}">
        @csrf
   ...
   <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <label for="nombre" >{{ __(' Nombre(s)') }}</label>
                                <input id="nombre" type="text"  onKeyUp="this.value = this.value.toUpperCase()" class="form-control @error('nombre') is-invalid @enderror" name="nombre" value="{{ old('nombre') }}" required autocomplete="nombre" oninput="calcula(this)" onkeypress="return soloLetras(event)">
                                @error('nombre')
                        ...
                        <div class="form-group col-md-4">
                            <label for="apellido_materno" >{{ __('Apellido Materno') }}</label>
                                  <input id="apellido_materno"  onKeyUp="this.value = this.value.toUpperCase()"  type="text" class="form-control @error('apellido_materno') is-invalid @enderror" name="apellido_materno" value="{{ old('apellido_materno') }}" autocomplete="apellido_materno" oninput="calcula(this)" onkeypress="return soloLetras(event)">
