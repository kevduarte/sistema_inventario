...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-size: 2.0em; font-family:Constantia; font-weight: 900;">Jefe de departamento</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Jefe de dpto</a></li>
...
@if (Session::has('message'))
  ...
  <h2 style= "font-family: 'Initial';">Personal registrado como jefe de departamento</h2>
  ...
  <tbody>
   ...
   <tr>
    ...
    <td><a style="color: red;" href="{{ route('desactivar_jefedpto',$encargados->id_user)}}"><?php if($encargados->estado=='actual'){echo "Desactivar";}?></a></td>
     <td><a style="color: red;" href="{{ route('activar_jefedpto',$encargados->id_user)}}"><?php if($encargados->estado=='anterior'){echo "Activar";}?></a></td>
