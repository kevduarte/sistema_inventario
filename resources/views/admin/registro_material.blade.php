...
<div class="form-group col-md-4">
  ...
  <input type="text" class="form-control @error('num_serie') is-invalid @enderror" id="num_serie" value="{{ old('num_serie') }}" autocomplete="num_serie" name="num_serie" onKeyUp="this.value = this.value.toUpperCase()" autofocus>
  @error('num_serie')
  <span class="invalid-feedback" role="alert">
   <strong>{{ $message }}</strong>
 </span>
...
<div class="form-row">
  ...
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" id="marca" name="marca" value="{{ old('marca') }}" onKeyUp="this.value = this.value.toUpperCase()"  autocomplete="marca">
...
<div class="form-group col-md-4">
  ...
  <div class="input-group ">
   ...
   <select name="tipo" id="tipo" required class="form-control @error('tipo') is-invalid @enderror" oninput="mostrar_id_material();" autocomplete="tipo">
 ...
 <div class="form-group col-md-4">
   ...
   <div class="input-group ">
     ...
     <select name="area" id="area" required class="form-control" oninput="areas_mostrar();"  autocomplete="area">
...
<div class="form-row">
  ...
  <div class="form-group col-md-8">
    ...
    <textarea class="form-control" name="descripcion" id="descripcion" value="{{ old('descripcion') }}" rows="2" cols="80"></textarea>
  </div>
...
<div class="form-row">
 ...
 <div class="form-group col-md-4">
  ...
  <input type="tel" name="cantidad" id="cantidad" class="form-control" onkeypress="return numeros (event)" required>

</div>

<div class="form-group col-md-4">
  <label for="total">Cantidad</label>
  <input type="tel" name="total" id="total" class="form-control" onkeypress="return numeros (event)" required>
</div>

<div class="form-group col-md-4"  id="labels">
  <label for="medida">Unidad de medida</label>
  <select name="medida" id="medida" required disabled class="form-control">
...
<script type="text/javascript">
  ...
  function checar(id){
   if ( id == "si_material" ) {
    document.getElementById("num_serie").removeAttribute("disabled");
    ...
    document.getElementById("medida").setAttribute("disabled","disabled");
...
function nochecar(id){
  if ( id == "no_material" ) {
   document.getElementById("num_serie").setAttribute("disabled","disabled");
   document.getElementById("modelo").setAttribute("disabled","disabled");
   document.getElementById("medida").removeAttribute("disabled");
