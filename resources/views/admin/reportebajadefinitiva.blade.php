...
<table id="encabezado" >
  ...
  <tr >
    ...
    <td colspan="2" align="center" ><span align="center" style="font-size:11px; color:#757575;">"2020, Año de Leona Vicario, Benem&eacute;rita Madre de la Patria"</span></td>
...
?></span> </span></td></td>
  ...
  <td id="col_5">
  <td colspan="2" align="right"><span style="font-size:12px; font-family: 'Arial, Helvetica', sans-serif;"><strong>Asunto:</strong>Baja de material definitiva</span></td>
    </td>
    ...
    <br/><br/><br/>
     ...
     <tr>
      ...
      <td  style="font-size: 11px;"> {{$datos->area}}</td>
       <td colspan="1" style="font-size: 14px;"><strong>Tipo:</strong></td>
      <td  style="font-size: 11px;"> {{$datos->tipo}}</td>
       <td colspan="1" style="font-size: 14px;"><strong>Semestre:</strong> </td>
    <td style="font-size: 14px;"><?php date_default_timezone_set('UTC'); date_default_timezone_set("America/Mexico_City");
 echo $arrayMeses[date('m', strtotime($semestre->inicio_semestre))-1]." ".date('Y', strtotime($semestre->inicio_semestre));?> <?php date_default_timezone_set('UTC'); date_default_timezone_set("America/Mexico_City");
  echo "- ".$arrayMeses[date('m', strtotime($semestre->final_semestre))-1]." ".date('Y', strtotime($semestre->final_semestre));?></td>
...
<div id="firma" >
   ...
   Excelencia en Educación Tecnológica®
    <BR />
    “Tecnología Propia e Independencia Económica”<br/>
  </span>
    </p>
    <BR/>
...
<div id="footer">
  <hr style="height:1px; border:none; color:#FFCA7E; background-color:#FFCA7E; width:100%; text-align:center;">
    ...
    TEL. Tels. (951) 5015016 <BR />
    
   <strong>P&aacute;gina oficial: www.oaxaca.tecnm.mx</strong>
    </span>
    </p>
  </div>
