        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{ route('reporte_temporal')}}">baja temporal</a></li>
  ...
  @foreach($veruni as $uni)
      ...
      <tr>
        ...
        <td>{!! $uni->estado !!}</td>
             ...
             <td WIDTH="50"><a href="/baja_reporte/{{$uni->codigo_unidad}}/{{$uni->id_material}}" target="_blank"><button type="button" class="btn btn-info btn-sm">Generar</button></a></td>
