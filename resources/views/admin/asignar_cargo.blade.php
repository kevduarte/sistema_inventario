 ...
 <!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-size: 2.0em; font-family:Constantia; font-weight: 900;">Asignar cargo</h1>
          </div>
          <div class="col-sm-6">
...
<form method="POST" action="{{ route('alta_personal_cargo') }}">
   @csrf
  ...
  <div class="form-group col-md-4">
      ...
      <div class="input-group ">
       <select name="area" id="area" required class="form-control @error('area') is-invalid @enderror" disabled>
