...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 style="font-size: 2.0em; font-family:Constantia; font-weight: 900;">Actualizar Material.</h1>
      </div>
      <div class="col-sm-6">
...
@if (Session::has('message'))
 ...
 <div class="container" id="font1" >
    ...
    <form method="POST" action="{{ route('actualizar_material_prueba') }}">
      ...
      <div class="form-group col-md-4">
        <label for="num_serie">N_serie</label>
        <input type="text" value="{{$material->num_serie}}" disabled class="form-control @error('num_serie') is-invalid @enderror" 
       ...
       <input type="text" value="{{$material->num_serie}}" hidden class="form-control @error('num_serie') is-invalid @enderror" 
       id="num_serie" name="num_serie">
 </div>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-8">
        ...
        <input type="text" value="{{$material->descripcion}}" class="form-control @error('descrpcion') is-invalid @enderror" id="descripcion" name="descripcion">
         @error('descripcion')
        <span class="invalid-feedback" role="alert">
          <strong>{{ $message }}</strong>
        </span>
      ...
      <div class="form-group col-md-4">
  <label for="cantidad">Nuevas unidades</label>
 <input type="tel" name="cantidad" id="cantidad" class="form-control" onkeypress="return numeros (event)">

</div>

    <div class="form-group col-md-4">
        <label for="total">Unidades existentes</label>
        <input type="text"  value="{{$uni}}" disabled class="form-control @error('total') is-invalid @enderror" id="total" name="total">
         @error('total')
        <span class="invalid-feedback" role="alert">
          <strong>{{ $message }}</strong>
        </span>
